...
# Java server SDK for IBM Cloud Event Notifications service Version 0.2.2
...
--- | ---
[Event Notifications Service](https://cloud.ibm.com/apidocs/event-notifications) | com.ibm.cloud:event-notifications:0.2.2
...
### Gradle
```gradle
compile 'com.ibm.cloud:event-notifications:0.2.2'
```
