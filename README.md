...
# Java server SDK for IBM Cloud Event Notifications service Version 0.1.9
...
--- | ---
[Event Notifications Service](https://cloud.ibm.com/apidocs/event-notifications) | com.ibm.cloud:event-notifications:0.1.9
...
## Installation
The current version of this SDK is: 0.1.9
...
### Gradle
```gradle
compile 'com.ibm.cloud:event-notifications:0.1.9'
```
