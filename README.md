...
# Java server SDK for IBM Cloud Event Notifications service Version 0.1.6
...
--- | ---
[Event Notifications Service](https://cloud.ibm.com/apidocs/event-notifications) | com.ibm.cloud:event-notifications:0.1.6
...
### Gradle
```gradle
compile 'com.ibm.cloud:event-notifications:0.1.6'
```
