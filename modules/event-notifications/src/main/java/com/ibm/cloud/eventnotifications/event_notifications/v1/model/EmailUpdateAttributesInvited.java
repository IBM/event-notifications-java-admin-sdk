 ...
 * The email ids.
 */
public class EmailUpdateAttributesInvited extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(EmailUpdateAttributesInvited emailUpdateAttributesInvited) {
      this.add = emailUpdateAttributesInvited.add;
      this.remove = emailUpdateAttributesInvited.remove;
    }
    ...
    /**
     * Builds a EmailUpdateAttributesInvited.
     *
     * @return the new EmailUpdateAttributesInvited instance
     */
    public EmailUpdateAttributesInvited build() {
      return new EmailUpdateAttributesInvited(this);
    }
     ...
     * @return the EmailUpdateAttributesInvited builder
     */
  ...
  protected EmailUpdateAttributesInvited() { }

  protected EmailUpdateAttributesInvited(Builder builder) {
    add = builder.add;
   ...
   * New builder.
   *
   * @return a EmailUpdateAttributesInvited builder
   */
