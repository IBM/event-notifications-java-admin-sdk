 ...
 */
public class GetSourceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a GetSourceOptions.
     *
     * @return the new GetSourceOptions instance
     */
    public GetSourceOptions build() {
      return new GetSourceOptions(this);
    }
     ...
     *
     * @param instanceId the instanceId
     * @return the GetSourceOptions builder
     */
   ...
   * New builder.
   *
   * @return a GetSourceOptions builder
   */
