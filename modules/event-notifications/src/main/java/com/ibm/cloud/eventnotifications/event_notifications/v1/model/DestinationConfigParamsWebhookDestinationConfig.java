 ...
 */
public class DestinationConfigParamsWebhookDestinationConfig extends DestinationConfigParams {
  ...
  public static class Builder {
    ...
    public Builder(DestinationConfigParams destinationConfigParamsWebhookDestinationConfig) {
      this.url = destinationConfigParamsWebhookDestinationConfig.url;
      this.verb = destinationConfigParamsWebhookDestinationConfig.verb;
      this.customHeaders = destinationConfigParamsWebhookDestinationConfig.customHeaders;
      this.sensitiveHeaders = destinationConfigParamsWebhookDestinationConfig.sensitiveHeaders;
    }
    ...
    /**
     * Builds a DestinationConfigParamsWebhookDestinationConfig.
     *
     * @return the new DestinationConfigParamsWebhookDestinationConfig instance
     */
    public DestinationConfigParamsWebhookDestinationConfig build() {
      return new DestinationConfigParamsWebhookDestinationConfig(this);
    }
     ...
     * @return the DestinationConfigParamsWebhookDestinationConfig builder
     */
   ...
   * New builder.
   *
   * @return a DestinationConfigParamsWebhookDestinationConfig builder
   */
