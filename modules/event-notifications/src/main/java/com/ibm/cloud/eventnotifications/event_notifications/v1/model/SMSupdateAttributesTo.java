 ...
 */
public class SMSupdateAttributesTo extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(SMSupdateAttributesTo smSupdateAttributesTo) {
      this.add = smSupdateAttributesTo.add;
      this.remove = smSupdateAttributesTo.remove;
    }
    ...
    /**
     * Builds a SMSupdateAttributesTo.
     *
     * @return the new SMSupdateAttributesTo instance
     */
    public SMSupdateAttributesTo build() {
      return new SMSupdateAttributesTo(this);
    }
     ...
     * @return the SMSupdateAttributesTo builder
     */
  ...
  protected SMSupdateAttributesTo() { }

  protected SMSupdateAttributesTo(Builder builder) {
    add = builder.add;
   ...
   * New builder.
   *
   * @return a SMSupdateAttributesTo builder
   */
