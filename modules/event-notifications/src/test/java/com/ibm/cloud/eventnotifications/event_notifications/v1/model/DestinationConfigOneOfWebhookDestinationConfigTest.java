...
/**
 * Unit test class for the DestinationConfigOneOfWebhookDestinationConfig model.
 */
public class DestinationConfigOneOfWebhookDestinationConfigTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDestinationConfigOneOfWebhookDestinationConfig() throws Throwable {
    ...
    DestinationConfigOneOfWebhookDestinationConfig destinationConfigOneOfWebhookDestinationConfigModelNew = TestUtilities.deserialize(json, DestinationConfigOneOfWebhookDestinationConfig.class);
    assertTrue(destinationConfigOneOfWebhookDestinationConfigModelNew instanceof DestinationConfigOneOfWebhookDestinationConfig);
    assertEquals(destinationConfigOneOfWebhookDestinationConfigModelNew.url(), "testString");
    assertEquals(destinationConfigOneOfWebhookDestinationConfigModelNew.verb(), "get");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDestinationConfigOneOfWebhookDestinationConfigError() throws Throwable {
    new DestinationConfigOneOfWebhookDestinationConfig.Builder().build();
  }
