...
/**
 * Unit test class for the NotificationDevices model.
 */
public class NotificationDevicesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testNotificationDevices() throws Throwable {
    ...
    String json = TestUtilities.serialize(notificationDevicesModel);

    NotificationDevices notificationDevicesModelNew = TestUtilities.deserialize(json, NotificationDevices.class);
    assertTrue(notificationDevicesModelNew instanceof NotificationDevices);
  }
}