...
/**
 * Unit test class for the CreateSmtpConfigurationOptions model.
 */
public class CreateSmtpConfigurationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateSmtpConfigurationOptions() throws Throwable {
  ...
  public void testCreateSmtpConfigurationOptionsError() throws Throwable {
    new CreateSmtpConfigurationOptions.Builder().build();
  }
