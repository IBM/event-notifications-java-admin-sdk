...
/**
 * Unit test class for the DestinationConfigParamsFirefoxDestinationConfig model.
 */
public class DestinationConfigParamsFirefoxDestinationConfigTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDestinationConfigParamsFirefoxDestinationConfig() throws Throwable {
    ...
    DestinationConfigParamsFirefoxDestinationConfig destinationConfigParamsFirefoxDestinationConfigModelNew = TestUtilities.deserialize(json, DestinationConfigParamsFirefoxDestinationConfig.class);
  ...
  public void testDestinationConfigParamsFirefoxDestinationConfigError() throws Throwable {
    new DestinationConfigParamsFirefoxDestinationConfig.Builder().build();
  }
