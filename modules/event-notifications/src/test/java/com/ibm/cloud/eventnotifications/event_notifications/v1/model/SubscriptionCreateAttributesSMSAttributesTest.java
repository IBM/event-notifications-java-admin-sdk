...
/**
 * Unit test class for the SubscriptionCreateAttributesSMSAttributes model.
 */
public class SubscriptionCreateAttributesSMSAttributesTest {
  ...
  public void testSubscriptionCreateAttributesSMSAttributes() throws Throwable {
    ...
    SubscriptionCreateAttributesSMSAttributes subscriptionCreateAttributesSmsAttributesModelNew = TestUtilities.deserialize(json, SubscriptionCreateAttributesSMSAttributes.class);
    assertTrue(subscriptionCreateAttributesSmsAttributesModelNew instanceof SubscriptionCreateAttributesSMSAttributes);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testSubscriptionCreateAttributesSMSAttributesError() throws Throwable {
    new SubscriptionCreateAttributesSMSAttributes.Builder().build();
  }
