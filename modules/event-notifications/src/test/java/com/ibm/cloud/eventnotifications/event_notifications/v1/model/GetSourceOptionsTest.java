...
/**
 * Unit test class for the GetSourceOptions model.
 */
public class GetSourceOptionsTest {
  ...
  public void testGetSourceOptionsError() throws Throwable {
    new GetSourceOptions.Builder().build();
  }
