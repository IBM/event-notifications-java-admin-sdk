...
/**
 * Unit test class for the NotificationFCMBody model.
 */
public class NotificationFCMBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testNotificationFCMBody() throws Throwable {
    NotificationFCMBody notificationFcmBodyModel = new NotificationFCMBody();
    assertNotNull(notificationFcmBodyModel);
  }
}