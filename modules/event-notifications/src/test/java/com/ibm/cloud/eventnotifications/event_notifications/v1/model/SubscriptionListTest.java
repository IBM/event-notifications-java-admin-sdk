...
/**
 * Unit test class for the SubscriptionList model.
 */
public class SubscriptionListTest {
  ...
  @Test
  public void testSubscriptionList() throws Throwable {
    SubscriptionList subscriptionListModel = new SubscriptionList();
    assertNull(subscriptionListModel.getTotalCount());
