...
/**
 * Unit test class for the DestinationResponse model.
 */
public class DestinationResponseTest {
  ...
  @Test
  public void testDestinationResponse() throws Throwable {
    DestinationResponse destinationResponseModel = new DestinationResponse();
    assertNull(destinationResponseModel.getId());
