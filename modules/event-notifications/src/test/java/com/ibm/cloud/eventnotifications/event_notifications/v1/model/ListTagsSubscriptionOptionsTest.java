...
/**
 * Unit test class for the ListTagsSubscriptionOptions model.
 */
public class ListTagsSubscriptionOptionsTest {
  ...
  public void testListTagsSubscriptionOptionsError() throws Throwable {
    new ListTagsSubscriptionOptions.Builder().build();
  }
