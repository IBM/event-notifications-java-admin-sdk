...
/**
 * Unit test class for the DestinationConfigParamsFCMDestinationConfig model.
 */
public class DestinationConfigParamsFCMDestinationConfigTest {
  ...
  public void testDestinationConfigParamsFCMDestinationConfigError() throws Throwable {
    new DestinationConfigParamsFCMDestinationConfig.Builder().build();
  }
