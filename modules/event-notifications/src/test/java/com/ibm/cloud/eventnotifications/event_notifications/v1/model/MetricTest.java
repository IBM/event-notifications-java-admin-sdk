...
/**
 * Unit test class for the Metric model.
 */
public class MetricTest {
  ...
  @Test
  public void testMetric() throws Throwable {
    Metric metricModel = new Metric();
    assertNull(metricModel.getKey());
    assertNull(metricModel.getDocCount());
    assertNull(metricModel.getHistogram());
  }
}