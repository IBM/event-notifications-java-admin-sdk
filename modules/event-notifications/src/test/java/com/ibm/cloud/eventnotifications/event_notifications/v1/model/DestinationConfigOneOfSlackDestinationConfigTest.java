...
/**
 * Unit test class for the DestinationConfigOneOfSlackDestinationConfig model.
 */
public class DestinationConfigOneOfSlackDestinationConfigTest {
  ...
  public void testDestinationConfigOneOfSlackDestinationConfig() throws Throwable {
    ...
    assertEquals(destinationConfigOneOfSlackDestinationConfigModel.type(), "incoming_webhook");
    ...
    assertEquals(destinationConfigOneOfSlackDestinationConfigModelNew.type(), "incoming_webhook");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDestinationConfigOneOfSlackDestinationConfigError() throws Throwable {
    new DestinationConfigOneOfSlackDestinationConfig.Builder().build();
  }
