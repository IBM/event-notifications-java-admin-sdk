...
/**
 * Unit test class for the UpdateSourceOptions model.
 */
public class UpdateSourceOptionsTest {
  ...
  public void testUpdateSourceOptionsError() throws Throwable {
    new UpdateSourceOptions.Builder().build();
  }
