...
/**
 * Unit test class for the Topic model.
 */
public class TopicTest {
  ...
  public void testTopic() throws Throwable {
    ...
    assertNull(topicModel.getId());
    assertNull(topicModel.getDescription());
    assertNull(topicModel.getName());
    assertNull(topicModel.getUpdatedAt());
    assertNull(topicModel.getSourceCount());
    assertNull(topicModel.getSources());
    assertNull(topicModel.getSubscriptionCount());
    assertNull(topicModel.getSubscriptions());
  }
}