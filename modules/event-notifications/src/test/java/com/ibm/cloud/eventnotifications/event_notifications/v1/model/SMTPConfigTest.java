...
/**
 * Unit test class for the SMTPConfig model.
 */
public class SMTPConfigTest {
  ...
  @Test
  public void testSMTPConfig() throws Throwable {
    SMTPConfig smtpConfigModel = new SMTPConfig();
    assertNull(smtpConfigModel.getDkim());
    assertNull(smtpConfigModel.getEnAuthorization());
    assertNull(smtpConfigModel.getSpf());
  }
}