...
/**
 * Unit test class for the DestinationListItem model.
 */
public class DestinationListItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDestinationListItem() throws Throwable {
    DestinationListItem destinationListItemModel = new DestinationListItem();
    assertNull(destinationListItemModel.getId());
