...
// >>> Replace "event_notifications" with the correct value for your project
package com.ibm.cloud.event_notifications.common;
...
public class SdkCommon {
    ...
    // >>> Replace "event-notifications" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "event-notifications";
